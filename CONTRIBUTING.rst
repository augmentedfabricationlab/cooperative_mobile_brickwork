...
1. Fork `the repository <https://github.com/augmentedfabricationlab/cooperative_mobile_brickwork>`_ and clone the fork.
...
When `reporting a bug <https://github.com/augmentedfabricationlab/cooperative_mobile_brickwork/issues>`_
please include:
...
`Github <https://github.com/augmentedfabricationlab/cooperative_mobile_brickwork/issues>`_. If you are proposing a feature:
