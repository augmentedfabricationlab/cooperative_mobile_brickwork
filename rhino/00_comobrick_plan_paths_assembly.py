...
# picking frame
picking_frame = Plane.from_data(data['picking_frame'])
picking_frame_safe = Plane.from_data(data['picking_frame_safe'])
# placing frame
placing_frame_safe = Plane.from_data(data['placing_frame_safe'])
# picking configuration
picking_configuration = Configuration.from_data(data['picking_configuration'])
#start configuration
start_configuration = Configuration.from_data(data['free_move_start_config'])
...
with RosClient('localhost') as client:
    ...
    for key in sequence:
        ...
        element.trajectory = [moving_trajectory, placing_trajectory]
